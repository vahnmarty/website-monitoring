...
$(document).ready(function(){
    ...
    /* ------------------------------------- */
      ...
      $('a#open-more-info').on( "click", function() {  
	      ...
	      if ($(".overlay").hasClass("skew-part") === false && $("#right-side").hasClass("hide-right") === false && $("#close-more-info").hasClass("hide-close") === false && $("#info-all").hasClass("hidden") === false) {
        ...
        } else if ($(".overlay").hasClass("skew-part") === false && $("#right-side").hasClass("hide-right") === false && $("#close-more-info").hasClass("hide-close") === false && $("#info-all").hasClass("hidden") == true) {
	        
	    $("#pp").addClass("hidden");
		$("#term").addClass("hidden");
		$("#info-all").removeClass("hidden");
        setTimeout(function() {
            $("#mcs_container").mCustomScrollbar("scrollTo", "#right-side",{
                scrollInertia:500,
                callbacks:false
        ...
        $('a#open-more-info-bm').on( "click", function() {  
	      
	      if ($(".overlay").hasClass("skew-part") === false && $("#right-side").hasClass("hide-right") === false && $("#close-more-info").hasClass("hide-close") === false && $("#info-all").hasClass("hidden") === false) {
		      
        setTimeout(function() {
            $("#mcs_container").mCustomScrollbar("scrollTo", "#bussmod",{
                scrollInertia:500,
                callbacks:false
            });
        }, 350);
        ...
        setTimeout(function() {
         ...
         $('a#open-more-info-cu').on( "click", function() {  
	      
	      if ($(".overlay").hasClass("skew-part") === false && $("#right-side").hasClass("hide-right") === false && $("#close-more-info").hasClass("hide-close") === false && $("#info-all").hasClass("hidden") === false) {
		      
        setTimeout(function() {
            $("#mcs_container").mCustomScrollbar("scrollTo", "#contactus",{
                scrollInertia:500,
                callbacks:false
            });
        }, 350);
        ...
        setTimeout(function() {
          ...
          $('a#open-more-info-pp').on( "click", function() {  
	      
	      if ($(".overlay").hasClass("skew-part") === false && $("#right-side").hasClass("hide-right") === false && $("#close-more-info").hasClass("hide-close") === false && $("#info-all").hasClass("hidden") === false) {
		      
		$("#pp").removeClass("hidden");
		$("#term").addClass("hidden");
		$("#info-all").addClass("hidden");
        setTimeout(function() {
            $("#mcs_container").mCustomScrollbar("scrollTo", "#pp",{
                scrollInertia:500,
                callbacks:false
            });
        }, 350);
        
        } else if ($(".overlay").hasClass("skew-part") === false && $("#right-side").hasClass("hide-right") === false && $("#close-more-info").hasClass("hide-close") === false && $("#pp").hasClass("hidden") == true) {
        ...
        setTimeout(function() {
            $("#mcs_container").mCustomScrollbar("scrollTo", "#pp",{
             ...
             $('a#open-more-info-tr').on( "click", function() {  
		...
		$("#info-all").addClass("hidden");
        setTimeout(function() {
            $("#mcs_container").mCustomScrollbar("scrollTo", "#term",{
                scrollInertia:500,
                callbacks:false
            });
        }, 350);
        
        } else if ($(".overlay").hasClass("skew-part") === false && $("#right-side").hasClass("hide-right") === false && $("#close-more-info").hasClass("hide-close") === false && $("#term").hasClass("hidden") == true) {
